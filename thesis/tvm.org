...
- Wspomnieć o problemach kolekcji tracing GC (w kontekście problemu =Erlang='a). [[cite:Gudeman1993]]
...
# TODO Jest to rozwiązanie alternatywne dla asymetrycznych architektur, gdzie dla różnych typów zadań istnieją dedykowane wątki, które skaluje się znacznie lepiej od asymetrycznego.
